...
insert  into `investigador`(`usuario_investigador`,`contrasena_investigador`,`nombre_investigador`,`informacion_investigador`,`telefono_investigador`,`celular_investigador`,`correo_investigador`,`genero_investigador`,`cvlac_investigador`,`id_tipo_investigador`,`id_nivel_permiso`,`estado_investigador`,`eliminado_investigador`) values ('admin','admin','Carlos Humberto','','111','222','casa','M','No',1,1,'A',''),('diana','diana','Diana Milena','Ninguna','133','212','otro','M','Si',3,1,'A',''),('jose','1234','Jose Camargo','<p>\r\n	AA</p>\r\n','343','343','3434','M','No',2,1,'A',NULL),('sonia','1234','Sonia Gamboa','<p>\r\n	AAA</p>\r\n','343','343','3434','F','No',1,1,'A',NULL);
...
insert  into `linea_investigacion`(`id_linea_investigacion`,`nombre_linea_investigacion`,`descripcion_linea_investigacion`,`estado_linea_investigacion`,`eliminado_linea_investigacion`) values (1,'Biología Computacional','Biología Computacional','A',NULL),(2,'Computación de Alto Rendimiento','Computación de Alto Rendimiento','A',NULL),(3,'Dispositivos móviles y Redes P2P','Dispositivos móviles y Redes P2P','A',NULL),(4,'Ingeniería de Software','Ingeniería de Software','A',NULL),(5,'Procesamiento de Imágenes y Señales Digitales','Procesamiento de Imágenes y Señales Digitales','A',NULL);
...
insert  into `lineas_investigador`(`id_linea`,`id_investigador`) values (1,'diana'),(2,'diana'),(1,'jose'),(5,'jose'),(3,'sonia'),(4,'sonia');
...
insert  into `proyecto`(`id_proyecto`,`nombre_proyecto`,`descripcion_proyecto`,`id_tipo_proyecto`,`id_estado_proyecto`,`id_linea`,`estado_proyecto`,`eliminado_proyecto`) values (1,'Celulas','Celulas',1,1,2,'A',NULL),(2,'Comunicaciones','Comunicaciones',2,1,3,'A',NULL),(3,'Computadora','Computadora',2,3,2,'A',NULL);
