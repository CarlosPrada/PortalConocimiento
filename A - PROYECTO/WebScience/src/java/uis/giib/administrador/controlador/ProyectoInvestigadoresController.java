...
import uis.giib.administrador.modelo.ProyectoInvestigadoresFacade;
...
public class ProyectoInvestigadoresController implements Serializable {
    ...
    @EJB
    private uis.giib.administrador.modelo.ProyectoInvestigadoresFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            current.getProyectoInvestigadoresPK().setIdProyecto(current.getProyecto().getIdProyecto());
            getFacade().create(current);
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("ProyectoInvestigadoresCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("ProyectoInvestigadoresUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("ProyectoInvestigadoresDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
        }
    }
