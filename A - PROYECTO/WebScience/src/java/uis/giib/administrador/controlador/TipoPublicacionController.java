...
import uis.giib.administrador.modelo.TipoPublicacionFacade;
...
public class TipoPublicacionController implements Serializable {
    ...
    @EJB
    private uis.giib.administrador.modelo.TipoPublicacionFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("TipoPublicacionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("TipoPublicacionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("TipoPublicacionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
        }
    }
