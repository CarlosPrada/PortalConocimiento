...
import uis.giib.administrador.modelo.SeccionFacade;
...
public class SeccionController implements Serializable {
    ...
    @EJB
    private uis.giib.administrador.modelo.SeccionFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("SeccionCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("SeccionUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("SeccionDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
        }
    }
