...
import uis.giib.administrador.modelo.EstadoProyectoFacade;
...
public class EstadoProyectoController implements Serializable {
    ...
    @EJB
    private uis.giib.administrador.modelo.EstadoProyectoFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("EstadoProyectoCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("EstadoProyectoUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
            return null;
    ...
    private void performDestroy() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Mensajes").getString("EstadoProyectoDeleted"));
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Mensajes").getString("PersistenceErrorOccured"));
        }
    }
    ...
    public EstadoProyecto getEstadoProyecto(java.lang.Integer id) {
    ...
    public static class EstadoProyectoControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getEstadoProyecto(getKey(value));
        }
