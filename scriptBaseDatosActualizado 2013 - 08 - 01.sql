...
insert  into `seccion`(`id_seccion`,`nombre_seccion`,`estado_seccion`,`eliminado_seccion`) values (1,'Eventos','A',NULL);
...
insert  into `tipo_publicacion`(`id_tipo_publicacion`,`nombre_tipo_publicacion`) values (1,'Evento');
